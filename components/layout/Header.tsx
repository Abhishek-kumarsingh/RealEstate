          ...
          <nav className="hidden md:flex items-center space-x-8">
            {navItems.map((item) => (
              <Link
                ...
                href={item.href}
                className={cn(
                  'text-sm font-bold transition-all duration-300 hover:text-primary relative',
                  'hover:drop-shadow-[0_0_8px_rgba(59,130,246,0.5)] dark:hover:drop-shadow-[0_0_8px_rgba(147,197,253,0.6)]',
                  pathname === item.href
                    ? 'text-primary font-bold drop-shadow-[0_0_6px_rgba(59,130,246,0.4)] dark:drop-shadow-[0_0_6px_rgba(147,197,253,0.5)]'
          ...
          <div className="px-2 pt-2 pb-3 space-y-1 bg-background shadow-lg">
            {navItems.map((item) => (
              <Link
                ...
                href={item.href}
                className={cn(
                  'block px-3 py-2 rounded-md text-base font-bold transition-all duration-300',
                  'hover:drop-shadow-[0_0_8px_rgba(59,130,246,0.5)] dark:hover:drop-shadow-[0_0_8px_rgba(147,197,253,0.6)]',
                  pathname === item.href
                    ? 'text-primary font-bold drop-shadow-[0_0_6px_rgba(59,130,246,0.4)] dark:drop-shadow-[0_0_6px_rgba(147,197,253,0.5)] bg-primary/10'
